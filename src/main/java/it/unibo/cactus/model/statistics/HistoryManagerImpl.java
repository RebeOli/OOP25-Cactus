 ...
 * Acts as a facade between the {@link HistoryRepository} and the {@link StatsCalculatorImpl},
...
public final class HistoryManagerImpl implements HistoryManager {
    ...
    private final StatsCalculatorImpl calculator;
     ...
     * @param calculator the {@link StatsCalculatorImpl} used to compute player
     *                   statistics from the loaded game results; must not be null.
     */
    public HistoryManagerImpl(final HistoryRepository repository, final StatsCalculatorImpl calculator) {
