...
public class RulesOverlay extends StackPane {
    ...
    public RulesOverlay() {
        ...
        final Label rulesText = new Label(
            ...
            "     wrong :( You receive a penalty card from the deck.\n\n" +
            "ENDING GAME\n" +
            "    Cactus! - If you think you have the lowest score, call Cactus! All other players get one final turn, then scores are counted.\n" +
            "    Empty - If a player runs out of cards, the game ends immediately."
